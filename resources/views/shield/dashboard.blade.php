                         ...
                         <table class="min-w-full text-sm font-light text-left whitespace-nowrap">
                            ...
                            <tbody>
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/1.png" alt="Samsung Galaxy S8 256GB"></div>
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/2.png" alt="Half Sleeve Shirt"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Half
                                           Sleeve Shirt</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/3.png" alt="Marco Shoes"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Marco
                                           Shoes</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/5.png" alt="Marco Shoes"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Marco
                                           Shoes</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/4.png" alt="15&quot; MackBook Pro"></div>
                         ...
                         <table class="min-w-full text-sm font-light text-left whitespace-nowrap">
                            ...
                            <tbody class="bg-white dark:bg-box-dark">
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/1.png" alt="Samsung Note 10 256GB"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Samsung
                                           Note
                                           10 256GB</span>
                                     </div>
                                  </td>
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/2.png" alt="Full Sleeve Shirt"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Full
                                           Sleeve
                                           Shirt</span>
                                     </div>
                                  </td>
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/3.png" alt="Nike Shoes"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Nike
                                           Shoes</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/5.png" alt="Bata Shoes"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Bata
                                           Shoes</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/4.png" alt="15&quot; MackBook Pro"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">15"
                                           MackBook
                                           Pro</span>
                                     </div>
                                  </td>
                         ...
                         <table class="min-w-full text-sm font-light text-left whitespace-nowrap">
                            ...
                            <tbody class="bg-white dark:bg-box-dark">
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/electronics/1.png" alt="Samsung Galaxy Premio 256GB">
                         ...
                         <table class="min-w-full text-sm font-light text-left whitespace-nowrap">
                            ...
                            <tbody class="bg-white dark:bg-box-dark">
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/browser/chrome.png" alt="Google Chrome"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Google
                                           Chrome</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/browser/firefox.png" alt="Google Chrome"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Google
                                           Chrome</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/browser/internet-explorer.png" alt="Google Chrome"></div>
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/browser/opera.png" alt="Google Chrome"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Google
                                           Chrome</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
                               ...
                               <tr class="group">
                                  <td class="ps-0 pe-4 py-2.5 text-start last:text-end text-dark dark:text-title-dark group-hover:bg-transparent text-15 font-medium border-none before:hidden rounded-s-[4px]">
                                     <div class="flex items-center">
                                        <div class="me-2.5 w-[34px] h-[34px]"><img class="min-w-[34px] h-[34px] rounded-4" src="images/browser/safari.png" alt="Google Chrome"></div><span class="font-medium capitalize text-dark dark:text-title-dark text-15">Google
                                           Chrome</span>
                                     </div>
                                  </td>
                                  <td class="px-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
...
<footer class="px-[25px] bg-white dark:bg-box-dark">
   ...
   <div class="flex justify-between flex-wrap py-[22px] gap-x-[30px] gap-y-[15px] max-ssm:gap-y-[8px] items-center max-md:flex-col">
      ...
      <div class="flex items-center gap-[4px] text-[14px] font-medium max-md:text-center text-body dark:text-subtitle-dark">© <span class="current-year"></span> <a href="#" class="text-primary">netops</a></div>

<!-- Footer navigation links -->
<div class="justify-end md:justify-center items-center flex gap-[15px]">
   <a href="https://netops.ink" target="_blank" rel="noopener noreferrer" class="text-body dark:text-subtitle-dark text-[14px] hover:text-primary dark:hover:text-title-dark">Contact</a>
</div>
   </div>
