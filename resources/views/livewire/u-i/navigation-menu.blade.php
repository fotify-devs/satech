    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            ...
            <div class="flex items-center space-x-6 text-sm">
                <a href="mailto:info@academy.edu" class="flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    <span class="hidden sm:inline">info@academy.edu</span>
                </a>
                <a href="tel:+1234567890" class="flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between space-x-6">
                ...
                <div class="flex space-x-4">
                    <a href="#" class="transform hover:scale-110 transition-transform duration-200">
                        <div class="p-2 rounded-full bg-white dark:bg-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                ...
                >
                    <span x-show="!darkMode" class="flex items-center text-yellow-500">
                        <svg class="h-4 w-4 group-hover:rotate-90 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex justify-between h-20">
                        ...
                        <div class="flex items-center">
                            <a href="" class="flex items-center group">
                                <x-application-mark class="block h-12 w-auto transform group-hover:scale-110 transition-transform duration-200" />
                                <span class="ml-3 text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Academy</span>
                            </a>
                        </div>
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            ...
                            @foreach(['Home', 'Academic', 'Admissions', 'Programs', 'Faculty', 'Research', 'Campus Life'] as $item)
                                <a href="#" class="px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-blue-50 dark:hover:bg-gray-800">
                                    {{ $item }}
                                </a>
                            @endforeach
                        ...
                        <div class="flex items-center md:hidden">
                            <button
                                ...
                                class="inline-flex items-center justify-center p-2 rounded-lg text-gray-600 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-gray-800 focus:outline-none transition duration-200">
